...
fineFTP Server
  ...
  - Included in:
    - Git submodule `/tirdparty/fineftp-server`
...
tcp_pubsub
  ...
  - Included in:
    - Git submodule `/tirdparty/tcp_pubsub`
    - Binary distributions for Windows
    - Binary distributions for Linux
...
Udpcap
  ...
  - Included in:
    - Git submodule `/tirdparty/udpcap`
    - Binary distributions for Windows
...
Google Protobuf
  ...
  - Included in:
    - Git submodule `/tirdparty/protobuf`
    - Binary distributions for Windows
...
Google Test
  ...
  - Copyright: 2008 Google Inc.
  - Included in:
    - Git submodule `/tirdparty/googletest`
...
recycle
  ...
  - Included in:
    - Git submodule `/tirdparty/recycle`
    - Binary distributions for Windows
    - Binary distributions for Linux
...
SimpleIni
  ...
  - Included in:
    - Git submodule `/tirdparty/simpleini`
    - Binary distributions for Windows
    - Binary distributions for Linux
...
spdlog
  ...
  - Included in:
    - Git submodule `/tirdparty/spdlog`
    - Binary distributions for Windows
    - Binary distributions for Linux
...
termcolor
  ...
  - Included in:
    - Git submodule `/tirdparty/termcolor`
    - Binary distributions for Windows
    - Binary distributions for Linux
...
TinyXML-2
  ...
  - Included in:
    - Git submodule `/tirdparty/tinyxml`
    - Binary distributions for Windows
    - Binary distributions for Linux
...
yaml-cpp
  ...
  - Included in:
    - Git submodule `/thirdparty/yaml-cpp`
    - Binary distributions for Windows
    - Binary distributions for Linux
