...
.. _file_ecal_core_include_ecal_ecal_callback.h:

File ecal_callback.h
====================


eCAL subscriber callback interface 
...
Definition (``ecal/core/include/ecal/ecal_callback.h``)
-------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_ecal_core_include_ecal_ecal_callback.h.rst
...
- ``ecal/cimpl/ecal_callback_cimpl.h``
