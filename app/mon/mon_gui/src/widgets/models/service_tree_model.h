...
private:
  ...
  std::map<Columns, int> tree_item_column_mapping =
  {
    ...
    { Columns::METHOD_REQUEST_ENCODING,  (int)ServiceTreeItem<eCAL::pb::Service>::Columns::REQ_ENCODING },
    { Columns::METHOD_RESPONSE_TYPE,     (int)ServiceTreeItem<eCAL::pb::Service>::Columns::RESP_TYPE },
    { Columns::METHOD_RESPONSE_ENCODING, (int)ServiceTreeItem<eCAL::pb::Service>::Columns::RESP_ENCODING },
