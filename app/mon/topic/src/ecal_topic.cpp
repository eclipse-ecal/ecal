...
/**
 * @brief eCALTopic Console Application
**/
...
int main(int argc, char** argv)
{
  try
  {
    ...
    std::string version_str = std::string(ECAL_TOPIC_VERSION) + " (" + std::string(ECAL_TOPIC_DATE) + ")";
    TCLAP::CmdLine cmd(ECAL_TOPIC_NAME, ' ' , version_str);
