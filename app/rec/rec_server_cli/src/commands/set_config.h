  ...
  namespace rec_cli
  {
    namespace command
    {
      ...
      //////////////////////////////////////////////
        struct CmdLine
        {
          CmdLine()
            ...
            , gzip_compression_arg    ("",            "gzip-compression", "Apply gzip compression with given compression level.", false, "", "Integer")
          ...
          TCLAP::ValueArg<std::string>          gzip_compression_arg; // => signed int!
      ...
      public:
        ...
        static eCAL::rec::Error setGzipCompressionLevel (const std::shared_ptr<eCAL::rec_server::RecServer>& rec_server_instance, const std::string& param);
      };
    }
  }
}
