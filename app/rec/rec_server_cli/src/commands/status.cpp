...
namespace eCAL
{
  namespace rec_cli
  {
    namespace command
    {
      ...
      eCAL::rec::Error Status::Execute(const std::string& hostname, const std::shared_ptr<eCAL::protobuf::CServiceClientUntyped<eCAL::pb::rec_server::EcalRecServerService>>& remote_rec_server_service, const std::vector<std::string>& argv) const
      {
      ...
      eCAL::rec::Error Status::printStatus(const std::string& hostname, const std::shared_ptr<eCAL::protobuf::CServiceClientUntyped<eCAL::pb::rec_server::EcalRecServerService>>& remote_rec_server_service) const
      {
        eCAL::rec_server::RecServerStatus status;
        eCAL::rec_server::RecServerConfig config;
      ...
      eCAL::rec::Error Status::printJobState(const std::string& hostname, const std::shared_ptr<eCAL::protobuf::CServiceClientUntyped<eCAL::pb::rec_server::EcalRecServerService>>& remote_rec_server_service, int64_t meas_id) const
      {
        eCAL::rec_server::RecServerStatus status;
        auto error = GetRemoteStatus(hostname, remote_rec_server_service, status);
      ...
      eCAL::rec::Error Status::printClientInformation(const std::string& hostname, const std::shared_ptr<eCAL::protobuf::CServiceClientUntyped<eCAL::pb::rec_server::EcalRecServerService>>& remote_rec_server_service, const std::string& client_hostname) const
      {
        eCAL::rec_server::RecServerStatus status;
        auto error = GetRemoteStatus(hostname, remote_rec_server_service, status);
