...
namespace eCAL
{
  namespace sys
  {
    ...
    /////////////////////////////////
    public:
      CommandExecutor(const std::shared_ptr<EcalSys>& ecalsys_instance, const std::string& remote_hostname, const std::shared_ptr<eCAL::protobuf::CServiceClientUntypedCallback<eCAL::pb::sys::Service>>& remote_ecalsys_service);
      ~CommandExecutor();
    ...
    private:
      ...
      std::shared_ptr<eCAL::protobuf::CServiceClientUntypedCallback<eCAL::pb::sys::Service>> remote_ecalsys_service_;
