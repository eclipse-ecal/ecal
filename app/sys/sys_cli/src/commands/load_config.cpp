...
namespace eCAL
{
  namespace sys
  {
    namespace command
    {
      ...
      eCAL::sys::Error LoadConfig::Execute(const std::string& /*hostname*/, const std::shared_ptr<eCAL::protobuf::CServiceClientUntypedCallback<eCAL::pb::sys::Service>>& /*remote_ecalsys_service*/, const std::vector<std::string>& /*argv*/) const
      {
