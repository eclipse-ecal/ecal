...
namespace eCAL
{
  namespace sys
  {
    namespace command
    {
      ...
      eCAL::sys::Error StartTask::Execute(const std::string& hostname, const std::shared_ptr<eCAL::protobuf::CServiceClientUntyped<eCAL::pb::sys::Service>>& remote_ecalsys_service, const std::vector<std::string>& argv) const
      {
        ...
        auto call_service_error = CallRemoteEcalsysService(remote_ecalsys_service, hostname, "StartTasks", task_request_pb, response_pb);
