...
public:
  ...
  eCAL::Process::eSeverity_Level  severity_level;       /**< The severity Level (Level 1 - 5) */
   ...
   */
  TaskState()
    : severity(eCAL::Process::eSeverity::proc_sev_unknown)
    , severity_level(eCAL::Process::eSeverity_Level::proc_sev_level1)
    , info("")
  {}
   ...
   */
  TaskState(eCAL::Process::eSeverity severity, eCAL::Process::eSeverity_Level severity_level)
    : severity(severity)
  ...
  bool FromString(const std::string& severity_string, const std::string& severity_level_string)
  {
    ...
    {
      severity = eCAL::Process::eSeverity::proc_sev_healthy;
    }
    else if (severity_string_lower == "warning")
    {
      severity = eCAL::Process::eSeverity::proc_sev_warning;
    }
    ...
    {
      severity = eCAL::Process::eSeverity::proc_sev_failed;
    }
    else
    {
      severity = eCAL::Process::eSeverity::proc_sev_unknown;
    ...
    {
      severity_level = eCAL::Process::eSeverity_Level::proc_sev_level2;
    }
    else if (severity_level_string_lower == "level3" || severity_level_string_lower == "level 3")
    {
      severity_level = eCAL::Process::eSeverity_Level::proc_sev_level3;
    }
    else if (severity_level_string_lower == "level4" || severity_level_string_lower == "level 4")
    {
      severity_level = eCAL::Process::eSeverity_Level::proc_sev_level4;
    }
    else if (severity_level_string_lower == "level5" || severity_level_string_lower == "level 5")
    {
      severity_level = eCAL::Process::eSeverity_Level::proc_sev_level5;
    }
    else
    {
      severity_level = eCAL::Process::eSeverity_Level::proc_sev_level1;
  ...
  void FromInt(int combined_severity)
  {
    ...
    static_assert((int)eCAL::Process::eSeverity::proc_sev_unknown == 0,      "Somebody shifted the severity values! We expect severities to have a rage 0-4 and severity levels to have a range of 1-5!");
    static_assert((int)eCAL::Process::eSeverity::proc_sev_failed  == 4,      "Somebody shifted the severity values! We expect severities to have a rage 0-4 and severity levels to have a range of 1-5!");
    static_assert((int)eCAL::Process::eSeverity_Level::proc_sev_level1 == 1, "Somebody shifted the severity values! We expect severities to have a rage 0-4 and severity levels to have a range of 1-5!");
    static_assert((int)eCAL::Process::eSeverity_Level::proc_sev_level5 == 5, "Somebody shifted the severity values! We expect severities to have a rage 0-4 and severity levels to have a range of 1-5!");
    ...
    severity_level = (eCAL::Process::eSeverity_Level)(combined_severity % 5 + 1);
  }
