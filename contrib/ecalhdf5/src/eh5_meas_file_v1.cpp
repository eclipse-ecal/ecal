...
bool eCAL::eh5::HDF5MeasFileV1::SetGZipCompressionFilter(unsigned level) {
    return false;
}

bool eCAL::eh5::HDF5MeasFileV1::IsGZipCompressionFilterEnabled() {
    return false;
}

bool eCAL::eh5::HDF5MeasFileV1::SetSZipCompressionFilter(unsigned options_mask, unsigned pixels_per_block) {
    return false;
}

bool eCAL::eh5::HDF5MeasFileV1::IsSZipCompressionFilterEnabled() {
    return false;
}

bool eCAL::eh5::HDF5MeasFileV1::SetChunkDimensions(int ndims, unsigned long long dim[/*ndims*/]) {
    return false;
}

bool eCAL::eh5::HDF5MeasFileV1::IsChunkingEnabled() {
    return false;
}