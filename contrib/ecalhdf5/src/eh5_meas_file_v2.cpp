...
bool eCAL::eh5::HDF5MeasFileV2::SetGZipCompressionFilter(unsigned level) {
    return false;
}

bool eCAL::eh5::HDF5MeasFileV2::IsGZipCompressionFilterEnabled() {
    return false;
}

bool eCAL::eh5::HDF5MeasFileV2::SetSZipCompressionFilter(unsigned options_mask, unsigned pixels_per_block) {
    return false;
}

bool eCAL::eh5::HDF5MeasFileV2::IsSZipCompressionFilterEnabled() {
    return false;
}

bool eCAL::eh5::HDF5MeasFileV2::SetChunkDimensions(int ndims, unsigned long long dim[/*ndims*/]) {
    return false;
}

bool eCAL::eh5::HDF5MeasFileV2::IsChunkingEnabled() {
    return false;
}