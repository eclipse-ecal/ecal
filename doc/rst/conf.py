...
if not os.path.exists(download_tables_main_page_dir) and not os.path.exists(download_archive_dir):
    ...
    if gh_api_key:
        ...
        sys.stderr.write("ERROR: Environment variable ECAL_GH_API_KEY not set. Skipping generating download tables.\n")
