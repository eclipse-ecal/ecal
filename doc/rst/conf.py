...
# These variables are otherwise hard-coded in generate_download_tables.py
main_page_generated_rst_file        = "_main_page_download_section.rst.txt"
download_archive_generated_rst_file = "download_archive.rst"
...
if not os.path.exists(download_tables_main_page_dir) or not os.path.exists(download_archive_dir):
    ...
    if gh_api_key:
        ...
        os.makedirs(download_tables_main_page_dir)
        os.makedirs(download_archive_dir)
        open(download_tables_main_page_dir + "/" + main_page_generated_rst_file , "w")
        open(download_archive_dir          + "/" + download_archive_generated_rst_file, "w")
