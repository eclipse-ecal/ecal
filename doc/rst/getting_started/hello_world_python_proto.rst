...
.. parsed-literal::
   ...
   └─ |fa-python| :download:`protobuf_snd.py </source_code_samples/python/protobuf/protobuf_snd.py>`
...
.. parsed-literal::
   ...
   └─ |fa-python| :download:`protobuf_rec.py </source_code_samples/python/protobuf/protobuf_rec.py>`

.. literalinclude:: /source_code_samples/python/protobuf/protobuf_rec.py
   :language: python
   :linenos:
