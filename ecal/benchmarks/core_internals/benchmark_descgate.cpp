...
namespace
{
  ...
  Registration::Sample MakeUnregPublisherSample(const Registration::Sample& reg)
  {
  ...
  std::vector<Registration::Sample> MakeMatchingUnregSamples(const std::vector<Registration::Sample>& reg)
  {
  ...
  void BM_ApplySample_ColdInsert(benchmark::State& state)
  {
  ...
  template<class GateT>
  void BM_ApplySample_ReapplyNoChange(benchmark::State& state)
  {
    const std::size_t N = static_cast<std::size_t>(state.range(0));
    std::vector<Registration::Sample> reg_samples;
  ...
  template<class GateT>
  void BM_ApplySample_Unregister(benchmark::State& state)
  {
    const std::size_t N = static_cast<std::size_t>(state.range(0));
    std::vector<Registration::Sample> reg_samples;
