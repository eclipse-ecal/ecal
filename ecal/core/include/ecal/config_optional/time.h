...
namespace eCAL
{
  namespace TimeOptional
  {
    struct Configuration
    {
      std::optional<std::string> timesync_module_rt{};             /*!< Time synchronisation interface name (dynamic library)
      ...
      std::optional<std::string> timesync_module_replay{};         //!< (Default: "")
    };
  }
}
