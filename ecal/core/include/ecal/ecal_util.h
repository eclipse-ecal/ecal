...
namespace eCAL
{
  namespace Util
  {
    ...
    **/
    ECAL_DEPRECATE_SINCE_5_13("Please use the method bool GetDataTypeDescription(const std::string& topic_name_, SDataTypeDescription& topic_info_) instead. You can extract the type information from the members encoding and type of the STopicInformation variable. This function will be removed in eCAL6.")
    ...
    **/
     ...
     * @return  True if succeeded.
    **/
    ECAL_DEPRECATE_SINCE_5_13("Please use the method bool GetDataTypeDescription(const std::string& topic_name_, SDataTypeDescription& topic_info_) instead. You can extract the descriptor from the STopicInformation variable. This function will be removed in eCAL6.")
    ...
    **/
     ...
     *
     * @param topic_name_   Topic name.
     * @param topic_info_   SDataTypeDescription to be filled by this function.
     *
     * @return True if TopicInformation for specified topic could be retrieved, false otherwise.
    **/
    ECAL_API bool GetDataTypeDescription(const std::string& topic_name_, SDataTypeDescription& topic_info_);
    ...
    **/
     ...
     * @brief Gets description of the specified topic.
     *
     * This function is deprecated with eCAL 5.10. Please use GetDataTypeDescription.
     *
     * @param topic_name_   Topic name.
     * @param topic_desc_   String to store description.
     *
