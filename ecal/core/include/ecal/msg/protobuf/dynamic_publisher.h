  ...
  namespace protobuf
  {
    ...
    **/
    ...
    public:
      ...
      **/
      CDynamicPublisher(const std::string& topic_name_, const std::shared_ptr<google::protobuf::Message>& msg_, const eCAL::Publisher::Configuration& config_ = eCAL::GetConfiguration().publisher)
