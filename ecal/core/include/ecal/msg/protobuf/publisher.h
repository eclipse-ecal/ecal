    ...
    **/
    ...
    public:
      ...
      **/
      ...
      explicit CPublisher(const std::string& topic_name_, const eCAL::Publisher::Configuration& config_ = eCAL::GetConfiguration().publisher) : eCAL::CPublisher(topic_name_, CPublisher::GetDataTypeInformation(), config_)
      {
      }
      ...
      **/
      bool Create(const std::string& topic_name_, const eCAL::Publisher::Configuration& config_ = eCAL::GetConfiguration().publisher)
      {
