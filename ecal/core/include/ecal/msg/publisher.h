...
namespace eCAL
{
  ...
  **/
  ...
  public:
    ...
    **/
    CMsgPublisher(const std::string& topic_name_, const struct SDataTypeInformation& data_type_info_, const Publisher::Configuration& config_ = eCAL::GetConfiguration().publisher) : CPublisher(topic_name_, data_type_info_, config_)
    {
    }
     ...
     * @param config_      Optional configuration parameters.
    **/
    explicit CMsgPublisher(const std::string& topic_name_, const Publisher::Configuration& config_ = eCAL::GetConfiguration().publisher) : CMsgPublisher(topic_name_, GetDataTypeInformation(), config_)
    {
    }
    ...
    **/
    bool Create(const std::string& topic_name_, const struct SDataTypeInformation& data_type_info_, const Publisher::Configuration& config_ = eCAL::GetConfiguration().publisher)
    {
