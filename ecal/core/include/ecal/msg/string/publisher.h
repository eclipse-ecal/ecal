    ...
    **/
    ...
    public:
      ...
      **/
      ...
      explicit CPublisher(const std::string& topic_name_, const eCAL::Publisher::Configuration& config_ = eCAL::GetCurrentConfig().publisher) : CMsgPublisher<T>(topic_name_, GetDataTypeInformation(), config_)
      {
      }
