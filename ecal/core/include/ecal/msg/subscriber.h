...
namespace eCAL
{
  ...
  **/
  ...
  public:
    ...
    **/
    ECAL_DEPRECATE_SINCE_5_13("Please use the constructor CMsgSubscriber(const std::string& topic_name_, const SDataTypeDescription& topic_info_) instead. This function will be removed in eCAL6. ")
    ...
    **/
    CMsgSubscriber(const std::string& topic_name_, const SDataTypeDescription& topic_info_) : CSubscriber(topic_name_, topic_info_)
    {
    }
    ...
    **/
    ECAL_DEPRECATE_SINCE_5_13("Please use the method CMsgSubscriber(const std::string& topic_name_, const SDataTypeDescription& topic_info_) instead. This function will be removed in eCAL6. ")
