...
namespace std
{
  ...
  public:
    ...
    {
      std::size_t h1 = std::hash<std::string>{}(datatype_info.name);
      std::size_t h2 = std::hash<std::string>{}(datatype_info.encoding);
      std::size_t h3 = std::hash<std::string>{}(datatype_info.descriptor);
