...
namespace eCAL
{
  namespace Config
  {
    std::stringstream getConfigAsYamlSS(const eCAL::Configuration& config_)
    {
      ...
      ss << R"(  # level: ["warning", "fatal", "debug1", ...])"                                                                     << "\n";
      ss << R"(  provider:)"                                                                                                        << "\n";
      ...
      ss << R"(      level: )"                                        << logToArray(config_.logging.provider.console.level)         << "\n";
      ...
      ss << R"(      level: )"                                        << logToArray(config_.logging.provider.file.level)            << "\n";
      ...
      ss << R"(      level: )"                                        << logToArray(config_.logging.provider.udp.level)             << "\n";
