...
namespace eCAL
{
  namespace Config
  {
    std::stringstream getConfigAsYamlSS(const eCAL::Configuration& config_)
    {
      ...
      ss << R"(      level: )"                                        << logToArray(config_.logging.sinks.console.filter_log)       << "\n";
      ...
      ss << R"(      level: )"                                        << logToArray(config_.logging.sinks.file.filter_log)          << "\n";
      ...
      ss << R"(      level: )"                                        << logToArray(config_.logging.sinks.udp.filter_log)           << "\n";
      ss << R"(    # File specific configuration)"                                                                                  << "\n";
      ss << R"(    file_config: )"                                                                                                  << "\n";
      ss << R"(      # Log file path)"                                                                                              << "\n";
      ss << R"(      path: )"                                         << quoteString(config_.logging.sinks.file_config.path)        << "\n";
      ss << R"(    # UDP specific configuration)"                                                                                   << "\n";
      ss << R"(    udp_config:)"                                                                                                    << "\n";
      ss << R"(      provider:)"                                                                                                    << "\n";
      ss << R"(      # UDP Port for sending logging data)"                                                                          << "\n";
      ss << R"(        port: )"                                       << config_.logging.sinks.udp_config.provider.port             << "\n";
      ss << R"(      receiver:)"                                                                                                    << "\n";
      ss << R"(        # Enable UDP log receiving)"                                                                                 << "\n";
      ss << R"(        enable: )"                                     << config_.logging.sinks.udp_config.receiver.enable           << "\n";
      ss << R"(        # UDP Port for receiving logging data)"                                                                      << "\n";
      ss << R"(        port: )"                                       << config_.logging.sinks.udp_config.receiver.port             << "\n";
      ss << R"()"                                                                                                                   << "\n";
