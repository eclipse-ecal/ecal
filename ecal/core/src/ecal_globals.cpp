...
namespace eCAL
{
  ...
  int CGlobals::Initialize(unsigned int components_, std::vector<std::string>* config_keys_ /*= nullptr*/)
  {
    ...
    {
      config_instance = std::unique_ptr<CConfig>(std::make_unique<CConfig>());
      if (config_keys_)
      {
    ...
    {
      entity_register_instance = std::unique_ptr<CEntityRegister>(std::make_unique<CEntityRegister>());
      new_initialization = true;
    }
    ...
    {
      descgate_instance = std::unique_ptr<CDescGate>(std::make_unique<CDescGate>());
      new_initialization = true;
    }
    ...
    {
      reggate_instance = std::unique_ptr<CRegGate>(std::make_unique<CRegGate>());
      new_initialization = true;
    }
    ...
    {
      memfile_map_instance = std::unique_ptr<SMemFileMap>(std::make_unique<SMemFileMap>());
      new_initialization = true;
    }
    ...
    {
      memfile_pool_instance = std::unique_ptr<CMemFileThreadPool>(std::make_unique<CMemFileThreadPool>());
      new_initialization = true;
    }
    ...
    if (components_ & Init::Subscriber)
    {
      ...
      {
        subgate_instance = std::unique_ptr<CSubGate>(std::make_unique<CSubGate>());
        new_initialization = true;
      }
    }
    ...
    if (components_ & Init::Publisher)
    {
      ...
      {
        pubgate_instance = std::unique_ptr<CPubGate>(std::make_unique<CPubGate>());
        new_initialization = true;
      }
    }
    ...
    if (components_ & Init::Service)
    {
      ...
      {
        servgate_instance = std::unique_ptr<CServGate>(std::make_unique<CServGate>());
        new_initialization = true;
      }
    }
    ...
    if (components_ & Init::TimeSync)
    {
      ...
      {
        timegate_instance = std::unique_ptr<CTimeGate>(std::make_unique<CTimeGate>());
        new_initialization = true;
      }
    }
    ...
    if (components_ & Init::Monitoring)
    {
      ...
      {
        monitoring_instance = std::unique_ptr<CMonitoring>(std::make_unique<CMonitoring>());
        new_initialization = true;
      }
    }
    ...
    if (components_ & Init::Logging)
    {
      ...
      {
        log_instance = std::unique_ptr<CLog>(std::make_unique<CLog>());
        new_initialization = true;
      }
    }
