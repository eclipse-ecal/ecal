  ...
  **/
  ...
  namespace Util
  {
    ...
    static eCAL::pb::Monitoring GetMonitoring()
    {
      ...
      if (eCAL::g_monitoring() != nullptr)
        eCAL::g_monitoring()->GetMonitoring(monitoring);
    ...
    **/
    ...
    {
      if (g_registration_receiver() != nullptr)
        g_registration_receiver()->EnableLoopback(state_);
    }
    ...
    **/
    ...
    {
      if (g_pubgate() != nullptr)
        g_pubgate()->ShareDescription(state_);
    }
