...
namespace eCAL
{
  CMonitoring::CMonitoring(std::shared_ptr<CRegistrationReceiver> registration_receiver_)
  {
    m_monitoring_impl = std::make_unique<CMonitoringImpl>(std::move(registration_receiver_));
  }
