...
namespace eCAL
{
  ...
  void CPubGate::ApplyLocSubRegistration(const eCAL::pb::Sample& ecal_sample_)
  {
    ...
    TopicInformation topic_information{ eCALSampleToTopicInformation(ecal_sample_) };
  ...
  bool CPubGate::ApplyTopicToDescGate(const std::string& topic_name_, const TopicInformation& topic_info_)
  {
