...
namespace eCAL
{
  ...
  public:
    ...
    bool RemoveEventCallback(Publisher_Event type_);
  ...
  protected:
    ...
    void FireEvent(const Publisher_Event type_, const SSubscriptionInfo& subscription_info_, const SDataTypeInformation& data_type_info_);
    ...
    using EventCallbackMapT = std::map<Publisher_Event, v5::PubEventCallbackT>;
