...
namespace eCAL
{
  ...
  public:
    ...
    void ApplyLocPublication(const std::string& process_id_, const std::string& tid_, const TopicInformation& tinfo_);
    void RemoveLocPublication(const std::string& process_id_, const std::string& tid_);

    void ApplyExtPublication(const std::string& host_name_, const std::string& process_id_, const std::string& tid_, const TopicInformation& tinfo_);
    ...
    TopicInformation GetTopicInformation() const {return(m_topic_info);}
  ...
  protected:
    ...
    void Connect(const std::string& tid_, const TopicInformation& topic_info_);
    void Disconnect();
