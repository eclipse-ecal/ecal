...
namespace eCAL
{
  ...
  CDataWriterTCP::CDataWriterTCP(const std::string& host_name_, const std::string& topic_name_, const std::string& topic_id_, const eCAL::eCALWriter::TCP::SAttributes& attr_) :
    m_attributes(attr_)
  {
    {
