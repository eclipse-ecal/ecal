...
namespace eCAL
{
  ...
  {
    UDP::SSenderAttr BuildUDPSenderAttr(const SAttr& provider_attr_)
    {
      UDP::SSenderAttr sender_attr;
    ...
    UDP::SReceiverAttr BuildUDPReceiverAttr(const SAttr& provider_attr_)
    {
      UDP::SReceiverAttr receiver_attr;      
    ...
    SHM::SMemfileBroadcastAttr BuildSHMMemfileBroadcastAttr(const SAttr& provider_attr_)
    {
      SHM::SMemfileBroadcastAttr sender_attr;      
