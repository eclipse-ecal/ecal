  ...
  namespace nanopb
  {
    ...
    bool encode_service_methods_field(pb_ostream_t* stream, const pb_field_iter_t* field, void* const* arg)
    {
      ...
      for (const auto& method : *method_vec)
      {
        ...
        encode_string(pb_method.req_datatype.descriptor_information, method.req_datatype.descriptor);
        ...
        encode_string(pb_method.resp_datatype.descriptor_information, method.resp_datatype.descriptor);
    ...
    bool decode_service_methods_field(pb_istream_t* stream, const pb_field_iter_t* /*field*/, void** arg)
    {
      ...
      decode_string(pb_method.req_datatype.descriptor_information, method.req_datatype.descriptor);
      ...
      decode_string(pb_method.resp_datatype.descriptor_information, method.resp_datatype.descriptor);
