...
//  {
//    // TODO: put this class in the eCAL namespace
//
//    eCAL::CAsioServerSession::RequestCallbackT request_callback
//              = [this](const std::string& request, std::string& response) -> int
//                {
//                  // TODO: This must not use "this", but a weak_ptr to this
//                  return this->on_request(request, response);
//                };
//
//    eCAL::CAsioServerSession::EventCallbackT event_callback
//              = [this](eCAL_Server_Event server_event, const std::string& todo_name_this_whatever_it_is) -> void
//                {
//                  // TODO: This must not use "this", but a weak_ptr to this
//                  this->on_event(server_event, todo_name_this_whatever_it_is);
//                };
//
//    std::shared_ptr<eCAL::CAsioServerSession> new_session;
//    if (version == 0)
//    {
//      new_session = eCAL::CAsioServerSessionV0::create(io_service_, request_callback, event_callback);
//    }
//    else
//    {
//      new_session = eCAL::CAsioServerSessionV1::create(io_service_, request_callback, event_callback);
//    }
//
//    acceptor_.async_accept(new_session->socket()
//                          , [this, new_session, version](auto ec) // TODO: the this pointer is used. Therefore, the move and copy constructor must be deleted
//                            {
