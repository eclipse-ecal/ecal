...
namespace eCAL
{
  CServiceClientDeprecatedImpl::CServiceClientDeprecatedImpl()
    : m_service_client_impl(nullptr)
    , m_created(false)
  {
  }

  CServiceClientDeprecatedImpl::CServiceClientDeprecatedImpl(const std::string& service_name_)
    : m_service_client_impl(nullptr)
    , m_created(false)
  {
  ...
  CServiceClientDeprecatedImpl::CServiceClientDeprecatedImpl(const std::string& service_name_, const ServiceMethodInformationMapT& method_information_map_)
    : m_service_client_impl(nullptr)
    , m_created(false)
  {
  ...
  bool CServiceClientDeprecatedImpl::Create(const std::string& service_name_)
  {
    return Create(service_name_, ServiceMethodInformationMapT());
  }

  bool CServiceClientDeprecatedImpl::Create(const std::string& service_name_, const ServiceMethodInformationMapT& method_information_map_)
  {
  ...
  bool CServiceClientDeprecatedImpl::Destroy()
  {
    if (!m_created) return false;
  ...
  bool CServiceClientDeprecatedImpl::SetHostName(const std::string& host_name_)
  {
    if (!m_created) return false;
  ...
  bool CServiceClientDeprecatedImpl::Call(const std::string& method_name_, const std::string& request_, int timeout_)
  {
  ...
  bool CServiceClientDeprecatedImpl::Call(const std::string& method_name_, const std::string& request_, int timeout_, ServiceResponseVecT* service_response_vec_)
  {
  ...
  bool CServiceClientDeprecatedImpl::CallAsync(const std::string& method_name_, const std::string& request_, int /*timeout_*/)
  {
    if (!m_created || !m_response_callback) return false;
  ...
  bool CServiceClientDeprecatedImpl::AddResponseCallback(const ResponseCallbackT& callback_)
  {
    if (!m_created) return false;
  ...
  bool CServiceClientDeprecatedImpl::RemResponseCallback()
  {
    if (!m_created) return false;
  ...
  bool CServiceClientDeprecatedImpl::AddEventCallback(eCAL_Client_Event type_, ClientEventCallbackT callback_)
  {
    if (!m_created) return false;
  ...
  bool CServiceClientDeprecatedImpl::RemEventCallback(eCAL_Client_Event type_)
  {
    if (!m_created) return false;
  ...
  std::string CServiceClientDeprecatedImpl::GetServiceName()
  {
    if (!m_created) return "";
  ...
  bool CServiceClientDeprecatedImpl::IsConnected()
  {
    if (!m_created) return false;
