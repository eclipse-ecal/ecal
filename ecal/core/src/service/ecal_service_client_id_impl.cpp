...
namespace eCAL
{
  std::shared_ptr<CServiceClientIDImpl> CServiceClientIDImpl::CreateInstance(const std::string& service_name_, const ServiceMethodInformationMapT& method_information_map_)
  {
    auto instance = std::shared_ptr<CServiceClientIDImpl>(new CServiceClientIDImpl(service_name_, method_information_map_));
    return instance;
  }

  CServiceClientIDImpl::CServiceClientIDImpl(const std::string& service_name_, const ServiceMethodInformationMapT& method_information_map_) : m_service_name(service_name_), m_method_information_map(method_information_map_)
  {
...
#ifndef NDEBUG
    // log it
    Logging::Log(log_level_debug2, m_service_name + "::CServiceClientIDImpl::AddEventCallback");
#endif
...
#ifndef NDEBUG
    // log it
    Logging::Log(log_level_debug2, m_service_name + "::CServiceClientIDImpl::RemEventCallback");
#endif
  ...
  std::pair<bool, SServiceResponse> CServiceClientIDImpl::CallWithResponse(const Registration::SEntityId& entity_id_, const std::string& method_name_, const std::string& request_, int timeout_ms_)
  {
  ...
  bool CServiceClientIDImpl::CallWithCallback(const Registration::SEntityId& entity_id_, const std::string& method_name_, const std::string& request_, int timeout_ms_)
  {
  ...
  std::pair<bool, SServiceResponse> CServiceClientIDImpl::CallBlocking(const Registration::SEntityId& entity_id_,
  ...
  void CServiceClientIDImpl::ErrorCallback(const Registration::SEntityId& entity_id_, const std::string& method_name_, const std::string& error_message_)
  {
    std::lock_guard<std::mutex> const lock(m_response_callback_sync);
