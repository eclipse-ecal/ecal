...
namespace eCAL
{
  ...
  **/
  ...
  private:
    ...
    CServiceClientImpl(const std::string& service_name_, const ServiceMethodInformationMapT& method_information_map_, const ClientEventIDCallbackT& event_callback_);
