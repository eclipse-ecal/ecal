...
namespace eCAL
{
  namespace v5
  {
    ...
    public:
      ...
      bool AddEventCallback(Server_Event type_, ServerEventCallbackT callback_);
      bool RemEventCallback(Server_Event type_);
    ...
    private:
      ...
      std::map<Server_Event, ServerEventCallbackT> m_event_callback_map;
    };
  }
}
