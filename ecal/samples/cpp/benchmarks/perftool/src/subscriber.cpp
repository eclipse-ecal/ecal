  ...
  , log_print_verbose_times_(log_print_verbose_times)
{
  ...
  ecal_sub.AddReceiveCallback([this](const eCAL::Registration::STopicId& /*topic_id_*/, const eCAL::SDataTypeInformation& /*data_type_info_*/, const eCAL::SReceiveCallbackData& data_) { callback(data_); });
}
