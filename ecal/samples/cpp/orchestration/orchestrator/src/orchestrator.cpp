...
int main()
{
  ...
  const eCAL::protobuf::CServiceClient<orchestrator::ComponentService> component1("component1");
  const eCAL::protobuf::CServiceClient<orchestrator::ComponentService> component2("component2");
