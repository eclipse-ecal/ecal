...
namespace ecal_service
{
  ...
  /**
   * @brief The ecal_service::Server class represents a binary service server that can be used may multiple clients.
   * 
   ...
   * 
   * _Tip_:       Use the ecal_service::ServerManager class to manage the
