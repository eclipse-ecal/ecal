...
#include "ecal_service_tcp_protocol_v0.h"
...
namespace eCAL
{
  namespace service
  {
    namespace ProtocolV0
    {
      ...
      {        
        std::vector<asio::const_buffer> buffer_list { asio::buffer(reinterpret_cast<const char*>(header_buffer.get()), sizeof(eCAL::service::TcpHeaderV0))
