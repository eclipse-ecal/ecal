...
TEST_F(config_test_c, print) 
{
    std::cout << "application.startup.terminal_emulator: " << configuration0->application.startup.terminal_emulator << std::endl;
    std::cout << "application.sys.filter_excl: " << configuration0->application.sys.filter_excl << std::endl;
    std::cout << "communication_mode: " << configuration0->communication_mode << std::endl;
    std::cout << "logging.provider.console.enable: " << configuration0->logging.provider.console.enable << std::endl;
    std::cout << "logging.provider.console.log_level: " << configuration0->logging.provider.console.log_level << std::endl;
    std::cout << "logging.provider.file.enable: " << configuration0->logging.provider.file.enable << std::endl;
    std::cout << "logging.provider.file.log_level: " << configuration0->logging.provider.file.log_level << std::endl;
    std::cout << "logging.provider.file_config.path: " << configuration0->logging.provider.file_config.path << std::endl;
    std::cout << "logging.provider.udp.enable: " << configuration0->logging.provider.udp.enable << std::endl;
    std::cout << "logging.provider.udp.log_level: " << configuration0->logging.provider.udp.log_level << std::endl;
    std::cout << "logging.provider.udp_config.port: " << configuration0->logging.provider.udp_config.port << std::endl;
    std::cout << "logging.receiver.enable: " << configuration0->logging.receiver.enable << std::endl;
    std::cout << "logging.receiver.udp_config.port: " << configuration0->logging.receiver.udp_config.port << std::endl;
    std::cout << "publisher.layer.shm.acknowledge_timeout_ms: " << configuration0->publisher.layer.shm.acknowledge_timeout_ms << std::endl;
    std::cout << "publisher.layer.shm.enable: " << configuration0->publisher.layer.shm.enable << std::endl;
    std::cout << "publisher.layer.shm.memfile_buffer_count: " << configuration0->publisher.layer.shm.memfile_buffer_count << std::endl;
    std::cout << "publisher.layer.shm.memfile_min_size_bytes: " << configuration0->publisher.layer.shm.memfile_min_size_bytes << std::endl;
    std::cout << "publisher.layer.shm.memfile_reserve_percent: " << configuration0->publisher.layer.shm.memfile_reserve_percent << std::endl;
    std::cout << "publisher.layer.shm.zero_copy_mode: " << configuration0->publisher.layer.shm.zero_copy_mode << std::endl;
    std::cout << "publisher.layer.tcp.enable: " << configuration0->publisher.layer.tcp.enable << std::endl;
    std::cout << "publisher.layer.udp.enable: " << configuration0->publisher.layer.udp.enable << std::endl;
    std::cout << "publisher.layer_priority_local: " << configuration0->publisher.layer_priority_local << std::endl;
    std::cout << "publisher.layer_priority_local_length: " << configuration0->publisher.layer_priority_local_length << std::endl;
    std::cout << "publisher.layer_priority_remote: " << configuration0->publisher.layer_priority_remote << std::endl;
    std::cout << "publisher.layer_priority_remote_length: " << configuration0->publisher.layer_priority_remote_length << std::endl;
    std::cout << "registration.local.shm.domain: " << configuration0->registration.local.shm.domain << std::endl;
    std::cout << "registration.local.shm.queue_size: " << configuration0->registration.local.shm.queue_size << std::endl;
    std::cout << "registration.local.transport_type: " << configuration0->registration.local.transport_type << std::endl;
    std::cout << "registration.local.udp.port: " << configuration0->registration.local.udp.port << std::endl;
    std::cout << "registration.loopback: " << configuration0->registration.loopback << std::endl;
    std::cout << "registration.network.transport_typ: " << configuration0->registration.network.transport_type << std::endl;
    std::cout << "registration.network.udp.port: " << configuration0->registration.network.udp.port << std::endl;
    std::cout << "registration.registration_refresh: " << configuration0->registration.registration_refresh << std::endl;
    std::cout << "registration.registration_timeout: " << configuration0->registration.registration_timeout << std::endl;
    std::cout << "registration.shm_transport_domain: " << configuration0->registration.shm_transport_domain << std::endl;
    std::cout << "subscriber.drop_out_of_order_messages: " << configuration0->subscriber.drop_out_of_order_messages << std::endl;
    std::cout << "subscriber.layer.shm.enable: " << configuration0->subscriber.layer.shm.enable << std::endl;
    std::cout << "subscriber.layer.tcp.enable: " << configuration0->subscriber.layer.tcp.enable << std::endl;
    std::cout << "subscriber.layer.udp.enable: " << configuration0->subscriber.layer.udp.enable << std::endl;
    std::cout << "timesync.timesync_module_replay: " << configuration0->timesync.timesync_module_replay << std::endl;
    std::cout << "timesync.timesync_module_rt: " << configuration0->timesync.timesync_module_rt << std::endl;
    std::cout << "transport_layer.tcp.max_reconnections: " << configuration0->transport_layer.tcp.max_reconnections << std::endl;
    std::cout << "transport_layer.tcp.number_executor_reader: " << configuration0->transport_layer.tcp.number_executor_reader << std::endl;
    std::cout << "transport_layer.tcp.number_executor_writer: " << configuration0->transport_layer.tcp.number_executor_writer << std::endl;
    std::cout << "transport_layer.udp.config_version: " << configuration0->transport_layer.udp.config_version << std::endl;
    std::cout << "transport_layer.udp.join_all_interfaces: " << configuration0->transport_layer.udp.join_all_interfaces << std::endl;
    std::cout << "transport_layer.udp.local.group: " << configuration0->transport_layer.udp.local.group << std::endl;
    std::cout << "transport_layer.udp.local.ttl: " << configuration0->transport_layer.udp.local.ttl << std::endl;
    std::cout << "transport_layer.udp.mask: " << configuration0->transport_layer.udp.mask << std::endl;
    std::cout << "transport_layer.udp.network.group: " << configuration0->transport_layer.udp.network.group << std::endl;
    std::cout << "transport_layer.udp.network.ttl: " << configuration0->transport_layer.udp.network.ttl << std::endl;
    std::cout << "transport_layer.udp.npcap_enabled: " << configuration0->transport_layer.udp.npcap_enabled << std::endl;
    std::cout << "transport_layer.udp.port: " << configuration0->transport_layer.udp.port << std::endl;
    std::cout << "transport_layer.udp.receive_buffer: " << configuration0->transport_layer.udp.receive_buffer << std::endl;
    std::cout << "transport_layer.udp.send_buffer: " << configuration0->transport_layer.udp.send_buffer << std::endl;
    std::cout << "_impl: " << configuration0->_impl << std::endl;
}