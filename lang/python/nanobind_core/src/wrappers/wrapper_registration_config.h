...
namespace eCAL
{
    namespace Registration
    {
        namespace Layer
        {
            namespace SHM
            {
                struct CNBLayerSHMConfiguration
                {
            ...
            namespace UDP
            {
                struct CNBLayerUDPConfiguration
                {
        ...
        struct CNBRegistrationConfiguration
        {
            ...
            Layer::CNBLayerConfiguration layer;
        };
    }
}
