...
namespace CustomTclap
{
   ...
   *
   * The FuzzyValueSwitchArg aims to combine the advantages of the
   ...
   *         - {true  | on  | 1} result in true
   *         - {false | off | 0} result in false
   ...
   *
   */
  class FuzzyValueSwitchArg : public TCLAP::ValueArg<bool>
  {
  public:
    FuzzyValueSwitchArg(const std::string &flag, const std::string &name, const std::string &desc, bool req, bool value, const std::string &typeDesc, TCLAP::Visitor *v = NULL);
    FuzzyValueSwitchArg(const std::string &flag, const std::string &name, const std::string &desc, bool req, bool value, const std::string &typeDesc, TCLAP::CmdLineInterface &parser, TCLAP::Visitor *v = NULL);
