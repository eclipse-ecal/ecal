...
int main(int argc, char **argv)
{
  ...
  eCAL::Initialize(argc, argv, "monitoring entities", eCAL::Init::All);
  ...
  while(eCAL::Ok())
  {
    ...
    {
      // take snapshot :-)
      eCAL::Monitoring::GetMonitoring(monitoring, eCAL::Monitoring::Entity::Host);
    ...
    {
      // take snapshot :-)
      eCAL::Monitoring::GetMonitoring(monitoring, eCAL::Monitoring::Entity::Server | eCAL::Monitoring::Entity::Client);
    ...
    {
      // take snapshot :-)
      eCAL::Monitoring::GetMonitoring(monitoring, eCAL::Monitoring::Entity::Publisher | eCAL::Monitoring::Entity::Subscriber);
