...
namespace Pb.People {
    ...
    static PersonReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Pb.People.Person), global::Pb.People.Person.Parser, new[]{ "Id", "Name", "Stype", "Email", "Dog", "House" }, null, new[]{ typeof(global::Pb.People.Person.Types.SType) }, null)
          }));
    }
    #endregion
  ...
  public sealed partial class Person : pb::IMessage<Person> {
    ...
    public Person(Person other) : this() {
      ...
      stype_ = other.stype_;
      email_ = other.email_;
      Dog = other.dog_ != null ? other.Dog.Clone() : null;
      House = other.house_ != null ? other.House.Clone() : null;
    }
    ...
    private global::Pb.People.Person.Types.SType stype_ = 0;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    public void MergeFrom(Person other) {
      ...
      if (other.dog_ != null) {
        if (dog_ == null) {
          dog_ = new global::Pb.Animal.Dog();
        }
        Dog.MergeFrom(other.Dog);
      }
      if (other.house_ != null) {
        if (house_ == null) {
          house_ = new global::Pb.Environment.House();
        }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 24: {
            stype_ = (global::Pb.People.Person.Types.SType) input.ReadEnum();
            break;
          }
          case 34: {
