...
cmake_parse_arguments(INPUT "" 
  ...
  # let's see if this will work for CS  
...
function(PROTOBUF_TARGET_CSHARP TARGET_NAME PROTO_ROOT)
  ...
  #message(STATUS "ProtoFiles: ${PROTOBUF_TARGET_CSHARP_UNPARSED_ARGUMENTS}")
  #message(STATUS "install folder: ${PROTOBUF_TARGET_CSHARP_INSTALL_FOLDER}")
  ...
  message(STATUS "CS files ${proto_csharp}")
