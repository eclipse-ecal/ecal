...
int main(int /*argc*/, char** /*argv*/)
{
  ...
  {
    eCAL::capnproto::IChannel<AddressBook> addressbook_channel{ eCAL::measurement::GetChannel<eCAL::capnproto::IChannel<AddressBook>>(meas, *addressbook_channels.begin()) };
