...
namespace eCAL
{
  ...
  {
    /**
     * @brief Client class for typed callback calls.
     *
     * Provides only the templated CallWithCallback method.
     */
    template <typename T>
    class CServiceClientTypedCallback : public CServiceClientCallbackBase<T>
    {
    public:
