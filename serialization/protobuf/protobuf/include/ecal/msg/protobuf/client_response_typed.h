...
namespace eCAL
{
  ...
  {
    /**
     * @brief Client class for typed synchronous responses.
     *
     * Provides only the CallWithResponse method that is templated on the expected ResponseT.
     */
    template <typename T>
    class CServiceClientTypedResponse : public CServiceClientResponseBase<T>
    {
    public:
      using CServiceClientResponseBase<T>::CServiceClientResponseBase; // Inherit constructors

      /**
       * @brief Blocking call returning typed responses.
       *
       ...
       * @return A pair of overall success and a vector of typed responses.
       */
