...
int main()
{
  ...
  auto receive_lambda = [](const eCAL::Registration::STopicId& /*topic_id_*/, const pb::People::Person& person_, const long long /*time_*/, const long long /*clock_*/, const long long /*id_*/){
    std::cout << "------------------------------------------" << std::endl;
