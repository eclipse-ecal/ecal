...
def get_sbom():
    ...
    component_dir  = os.path.join(os.path.dirname(os.path.realpath(__file__)), "benchmark")
    ...
    sbom[component_name]["copyright"] =                 ecal_license_utils.get_copyright_from_file(os.path.join(component_dir, "include/benchmark/benchmark.h"))
