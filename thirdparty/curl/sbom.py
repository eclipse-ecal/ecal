...
def get_sbom():
    ...
    component_dir  = os.path.join(os.path.dirname(os.path.realpath(__file__)), "curl")
    ...
    sbom[component_name]["license"] =                   "curl"
    ...
    sbom[component_name]["copyright"] =                 ecal_license_utils.get_copyright_from_file(os.path.join(sbom[component_name]["license_files"][0]), skip_lines=1)
    sbom[component_name]["homepage"] =                  "https://curl.se/libcurl/"
