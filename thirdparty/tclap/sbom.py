...
def get_sbom():
    component_name = "tclap"
    component_dir  = os.path.join(os.path.dirname(os.path.realpath(__file__)), "tclap")
    ...
    sbom[component_name]["homepage"] =          "https://tclap.sourceforge.net/"
