...
.. _file_ecal_core_include_ecal_ecal_event.h:

File ecal_event.h
=================


eCAL event interface (deprecated, will be removed in future eCAL versions) 
...
Definition (``ecal/core/include/ecal/ecal_event.h``)
----------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_ecal_core_include_ecal_ecal_event.h.rst
...
- ``ecal/ecal_eventhandle.h`` (:ref:`file_ecal_core_include_ecal_ecal_eventhandle.h`)
